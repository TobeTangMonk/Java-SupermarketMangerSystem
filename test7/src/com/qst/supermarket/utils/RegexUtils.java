...
public class RegexUtils {
    ...
    public static void main(String[] args) {
         ...
         System.out.println("过滤中英文特殊字符: "+RegexUtils.stringFilter("中国~~!#$%%."));
         System.out.println("是否包含中英文特殊字符: "+RegexUtils.isContainsSpecialChar("12"));
         System.out.println("判断中文字符: "+RegexUtils.isChineseChar("中国！"));
         System.out.println("匹配汉字: " + RegexUtils.isChinese("中国！"));
         System.out.println("判断英文字符: "+RegexUtils.isEnglish("abc!"));
         System.out.println("判断合法字符: "+RegexUtils.isRightfulString("abc_-11AAA"));
         System.out.println("邮政编码验证: "+RegexUtils.isZipCode("162406"));
         System.out.println("身份证号码验证: "+RegexUtils.isIdCardNo("35052419880210133e"));
         System.out.println("手机号码验证: "+RegexUtils.isMobile("18918611111"));
         System.out.println("电话号码验证: "+RegexUtils.isPhone("8889333"));
         System.out.println("电话号码验证: "+RegexUtils.isNumeric("888.9333"));
         System.out.println("匹配密码: "+RegexUtils.isPwd("d888d_ddddd"));
         System.out.println("匹配密码: "+RegexUtils.isUrl("http://baidu.com"));
